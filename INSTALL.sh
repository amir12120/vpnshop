...
if [ -n "${DOMAIN}" ]; then
  echo " URL:    http${SSL_MODE:+s}://${DOMAIN}/"
else
  echo " URL:    http://SERVER_IP:${PORT}/"
fi
echo " Admin:  /admin  (user: ${ADMIN_USER})"
echo ""
...
echo ""
echo " Next steps:"
echo "   1. /admin/settings  -> set your deposit card number"
echo "   2. /admin/panels    -> add your Sanayi panel, hit 'test connection'"
echo "   3. /admin/plans     -> define your plans"
echo "=============================="
